...
import { TreeDataGridRCG } from '../../src/TreeDataGridRCG';

export const Route = createFileRoute('/RowColumnGrouping')({
...
const columns: ColumnOrColumnGroup<Row>[] = [
  SelectColumn,
  {
    ...
    name: 'Info',
    children: [
      { key: 'country', name: 'Country', frozen: false },
      { key: 'year', name: 'Year', frozen: false },
      { key: 'sport', name: 'Sport', frozen: false },
      { key: 'athlete', name: 'Athlete', frozen: false }
    ]
  },
  {
    key: 'medals',
